...
void main() {
	// FragColor1 = texelFetch(Image, ivec2(gl_FragCoord.xy), 0);
	// FragColor1 = texelFetch(Image, ivec2(gl_FragCoord.xy), 2);
	// FragColor1 = texelFetch(Image, (ivec2(gl_FragCoord.xy)) * 4, 0);
